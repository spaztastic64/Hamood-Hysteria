...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'stage': //Week 1
				var bg:BGSprite = new BGSprite('HamoodStage', 300, 100, 0.9, 0.9);
				//var bars:BGSprite = new BGSprite('Bars', 400, 0, 0.9, 0.9);
				add(bg);
				//add(bars);
		...
		bars.visible = !ClientPrefs.hideHud;
		add(bars);
		...
		timeTxt.setFormat(Paths.font("comici.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("comici.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("comici.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	public function startCountdown():Void
	{
		...
		var blackScreen:FlxSprite = new FlxSprite().makeGraphic(Std.int(FlxG.width * 2), Std.int(FlxG.height * 2), FlxColor.BLACK);
					add(blackScreen);
							...
							FlxTween.tween(blackScreen, {alpha: 0}, 2.8, {
								ease: FlxEase.linear,
								onComplete: function(twn:FlxTween) {
									remove(blackScreen);
								}
